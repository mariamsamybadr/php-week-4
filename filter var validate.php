<?php
  ...
  /*
    ...
    ------ FILTER_VALIDATE_URL
    ---------- Flag => FILTER_NULL_ON_FAILURE return null if it neither true nor false or if it anything else not only with true or false
  ...
  */
  ...
  ["flags" => FILTER_NULL_ON_FAILURE | FILTER_FLAG_PATH_REQUIRED | FILTER_FLAG_QUERY_REQUIRED])); // if we need to run all these flags
